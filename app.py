...
def process_text_and_store(all_text):
  ...
  collections = client.create_collection(name = "Knowledge_base")
...
def semantic_search(query, collections, top_k = 2):
  query_embedding = text_embedding_model.encode(query)
  results = collections.query(query_embeddings =[query_embedding.tolist()], n_results = top_k)
  return results
